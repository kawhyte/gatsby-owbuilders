...
import pool1 from "../images/house.jpg"
import pool2 from "../images/house.jpg"


function WhatWeDo() {
    return (
        <div className='bg-white'>
        <section className='max-w-6xl min-w-0 mx-auto mb-12 mt-20 '>
            <div className='mx-20 mt-10  sm:mx-auto grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3'>
                ...
                <p className='text-lg text-left sm:m-5 md:text-md font-Montserrat uppercase bg-orange-200 p-1 '>
                Project Management
                </p>
